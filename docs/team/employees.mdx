...
Stell dir vor du kannst wie im Restaurant einen Mitarbeiter nach Wunsch zusammenstellen. Wie würdest du den Mitarbeiter bestellen? (z.B. Ich brauche jemanden mit Vertriebserfahrung, der im nächsten Jahr 100k Umsatz generiert).

# Welche Mitarbeiter Form benötigst du?

Überleg dir, wie viel Budget und Seniority du brauchst (wie sehr die Person expertise haben sollte).
Beispielsweise wird dir ein erfahrener Sales Mitarbeiter der 80k pro Jahr kostet mehr Umsatz generieren als 4 Werksstudenten die auch 80k zusammen kosten.
...
Als wir am Anfang viele Minijobber hatten, mussten wir teilweise viel Zeit damit verbringen Aufgaben zu erklären. Oftmals hätte ich es schneller selber erklären können. Prozesse optimieren und dokumentieren ist dann wichtig.
