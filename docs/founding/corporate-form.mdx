...
- Für die Gründung einer Kapitalgesellschaft musst du einen Gesellschaftsvertrag aufsetzen.
  Hierfür empfehlt es sich entweder auf einen Mustervertrag zurück zugreifen oder den Vertrag von einem Notarbüro aufsetzen zu lassen.
- Sobald das erledigt ist, müssen alle Gesellschafter und Geschäftsführer (erneut) beim Notar erscheinen und es werden einige Angaben auf ihre Richitgkeit geprüft.

2. # Geschäftskonto eröffnen und Stammkapital einzahlen
3. # Eintragung ins Handelsregister:

- Nun muss der Einzahlunsbeleg dem Notar vorgelegt werden, damit dieser die Gesellschaft beim Amtsgericht zum Eintrag ins Handelsregister anmelden kann.
- Sofern das erledigt wurde, muss die Gesellschaft noch beim Gewerbe- und beim Finanzamt angemeldet werden.
- Mit der Anmeldung beim Finanzamt, erhälst du eine SteuerID für die Gesellschaft, die du brauchst, um einen Steuerberater zu beauftragen.
